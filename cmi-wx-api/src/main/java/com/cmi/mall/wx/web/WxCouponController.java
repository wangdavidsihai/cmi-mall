...
import com.cmi.mall.db.domain.LitemallCart;
...
import com.cmi.mall.db.service.CouponVerifyService;
import com.cmi.mall.db.service.LitemallCartService;
import com.cmi.mall.db.service.LitemallCouponService;
import com.cmi.mall.db.service.LitemallCouponUserService;
import com.cmi.mall.db.service.LitemallGrouponRulesService;
import com.cmi.mall.db.util.CouponConstant;
import com.cmi.mall.wx.annotation.LoginUser;
import com.cmi.mall.wx.dao.CouponVo;
import com.cmi.mall.wx.util.WxResponseCode;
...
public class WxCouponController {
	 ...
	 */
	@GetMapping("mylist")
	public Object mylist(@LoginUser Integer userId, @NonNull Short status,
		...
		List<LitemallCouponUser> couponUserList = couponUserService.queryList(userId, null, status, page, size, sort,
				order);
